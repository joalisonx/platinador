        ...
        <ul class="flex justify-center gap-6 mt-8 md:gap-8">
          <li>
            <a href={import.meta.env.VITE_GITHUB_URL} target="_blank">
              <svg class="h-6 w-6 fill-gray-200 transition hover:fill-gray-200/75" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
          ...
          <li>
            <a href={import.meta.env.VITE_DISCORD_URL} target="_blank">
              <svg class="h-6 w-6 fill-gray-200 transition hover:fill-gray-200/75" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
